...
class AskoStockImportCronTaskHandler extends ScheduledTaskHandler
{
    ...
    {
        file_put_contents("AskoStockImportControllerLog.txt",date("l jS \of F Y h:i:sA")."> Start Cron Main Product Import\n",FILE_APPEND);
        $this->AskoStockImportController->askoStockImport(Context::createDefaultContext());
        file_put_contents("AskoStockImportControllerLog.txt",date("l jS \of F Y h:i:sA")."> End Cron Main Product Import\n",FILE_APPEND);
    }
}
