...
class BorettiStockImportCronTaskHandler extends ScheduledTaskHandler
{
    ...
    {
        file_put_contents("BorettiStockImportControllerLog.txt",date("l jS \of F Y h:i:sA")."> Start Cron Main Product Import\n",FILE_APPEND);
        $this->BorettiStockImportController->borettiStockImport(Context::createDefaultContext());
        file_put_contents("BorettiStockImportControllerLog.txt",date("l jS \of F Y h:i:sA")."> End Cron Main Product Import\n",FILE_APPEND);
    }
}
