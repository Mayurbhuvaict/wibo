...
class HisenseStockImportCronTaskHandler extends ScheduledTaskHandler
{
    ...
    {
        file_put_contents("HisenseStockImportControllerLog.txt",date("l jS \of F Y h:i:sA")."> Start Cron Main Product Import\n",FILE_APPEND);
        $this->HisenseStockImportController->hisenseStockImport(Context::createDefaultContext());
        file_put_contents("HisenseStockImportControllerLog.txt",date("l jS \of F Y h:i:sA")."> End Cron Main Product Import\n",FILE_APPEND);
    }
}
