import template from './sw-cms-el-image-uwaankooponzezorg.html.twig';
import './sw-cms-el-image-uwaankooponzezorg.scss';

const { Component, Mixin, Filter } = Shopware;

Component.register('sw-cms-el-image-uwaankooponzezorg', {
    template,
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('image-uwaankooponzezorg');
        },
    },
});
