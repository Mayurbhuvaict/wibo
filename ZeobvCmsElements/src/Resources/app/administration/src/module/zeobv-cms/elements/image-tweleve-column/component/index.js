import template from './sw-cms-el-image-tweleve-column.html.twig';
import './sw-cms-el-image-tweleve-column.scss';

const { Component, Mixin, Filter } = Shopware;

Component.register('sw-cms-el-image-tweleve-column', {
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('image-tweleve-column');
            this.initElementData('image-tweleve-column');
